...
@else
    <form action="{{ url('/jabatan/' . $jabatan->jabatan_id . '/update_ajax') }}" method="POST" id="form-edit-jabatan">
        @csrf
        @method('PUT')
        <div id="modal-master" class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="keterangan" id="keterangan" class="form-control">{{ $jabatan->keterangan }}</textarea>

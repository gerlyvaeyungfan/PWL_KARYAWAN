        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="alert alert-danger">
                    ...
                    Data karyawan yang Anda cari tidak ditemukan.
                </div>
...
@else
    <form action="{{ url('/karyawan/' . $karyawan->karyawan_id . '/update_ajax') }}" method="POST" id="form-edit-karyawan">
        @csrf
        @method('PUT')
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <select name="jabatan_id" id="jabatan_id" class="form-control" required>
                            ...
                            @foreach($jabatan as $j)
                                <option value="{{ $j->jabatan_id }}" {{ $j->jabatan_id == $karyawan->jabatan_id ? 'selected' : '' }}>
                                    {{ $j->nama_jabatan }}
                                </option>
                            @endforeach
                        </select>
                        <small id="error-jabatan_id" class="form-text text-danger"></small>
                    </div>

                    <div class="form-group">
                        <label>Alamat</label>
                        <textarea name="alamat" id="alamat" class="form-control" required>{{ $karyawan->alamat }}</textarea>
                    ...
                    <div class="form-group">
                        ...
                        <small id="error-telepon" class="form-text text-danger"></small>
                    </div>

                    <div class="form-group">
                        <label>Email</label>
                        <input value="{{ $karyawan->email }}" type="email" name="email" id="email" class="form-control">
        ...
        $(document).ready(function() {
            $("#form-edit-karyawan").validate({
                rules: {
                    ...
                    telepon: { required: true, minlength: 5 },
                    email: {  email: true }
                },
